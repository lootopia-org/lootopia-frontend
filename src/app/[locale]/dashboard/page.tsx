...
import { useMe, useProfile, useJoinedHunts } from '@/lib/api/queries';
    ...
    <RoleGuard allowed={['player']}>
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          <StatCard icon={TrendingUp} label={t('stats.level')} value={level} accent="text-teal" index={0} loading={profileLoading} />

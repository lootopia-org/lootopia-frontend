    ...
    <div className="overflow-hidden">
      <section className="bg-gradient text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">{t('privacy.title')}</h1>
          <p className="text-sm text-orange-200 mt-6">{t('privacy.lastUpdated')}: April 15, 2025</p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          >
            <Card className="bg-orange-50 border-2 border-primary space-y-4">
              <h2 className="text-2xl font-bold text-dark">{t('privacy.contact.title')}</h2>
      ...
      <section className="py-12 px-4 bg-light">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-dark mb-6 text-center">{t('privacy.links.title')}</h2>
          <div className="grid md:grid-cols-3 gap-4">
            <a href="/terms" className="text-center p-6 bg-white rounded-lg hover:shadow-lg transition group">

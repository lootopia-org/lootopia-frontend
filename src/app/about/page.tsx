    ...
    <div className="overflow-hidden">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-dark mb-6">{t('about.ourMission')}</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-dark text-center mb-16">{t('about.ourValues')}</h2>
      ...
      <section className="py-20 px-4 bg-light">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-dark text-center mb-16">{t('about.ourTeam')}</h2>
            ...
            {team.map((member, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="text-center space-y-3">
                  <div className="w-20 h-20 bg-gradient rounded-full mx-auto" />
                  <div>
